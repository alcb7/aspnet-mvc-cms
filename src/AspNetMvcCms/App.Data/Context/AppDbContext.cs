    ...
    public class AppDbContext : DbContext
    {
		...
		protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<DoctorEntity>().HasData(
               ...
               new DoctorEntity { Id = 6, Name = "Kum", Surname = "Canbulan", Email = "kum@canbulan.com", Phone = "05554443322", Password = "1234", CategoryId = 6, ResimDosyaAdi = "doctor.1.jpg", Cv = "fdsjfıldjsfldjflıdjsfıjldsjfdsı", NavbarId = 5, Cat = "cat6" },
               new DoctorEntity { Id = 7, Name = "Gokhan  ", Surname = "Canbulan", Email = "gokhan@canbulan.com", Phone = "05554443322", Password = "1234", CategoryId = 4, ResimDosyaAdi = "doctor.1.jpg", Cv = "fdsjfıldjsfldjflıdjsfıjldsjfdsı", NavbarId = 5 ,Cat="cat4"}
               );
           ...
           new DoctorCommentEntity { Id = 1, Title = "Exemplary Care ", Description = "I recently had an experience at the hospital that exceeded my expectations. The staff was incredibly attentive and caring, making sure I felt comfortable throughout my stay. The facilities were clean and well-maintained, and I was impressed by the modern equipment they used.", DoctorId=1 },
           new DoctorCommentEntity { Id = 2, Title = "A Mixed Experience", Description = "My recent visit to the hospital was a mixed experience. On the positive side, the facility was clean, and the waiting times were reasonable. The nursing staff was generally attentive, although I did feel that communication could have been better.", DoctorId = 2 },
            new DoctorCommentEntity { Id = 3, Title = "Room for Improvement", Description = "Unfortunately, my recent encounter with this hospital was less than satisfactory. The overall atmosphere felt chaotic, and the staff appeared overworked and stressed. The facilities seemed outdated, and the waiting times were excessively long.", DoctorId = 3 }
